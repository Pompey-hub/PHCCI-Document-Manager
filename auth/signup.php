                    ...
                    <div>
                        ...
                        <form action="signup_process.php" method="POST">
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        ...
                                        <input :type="showPassword ? 'text' : 'password'" name="password"
                                            ...
                                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs"
                                            required />
                                ...
                                <!-- Terms Checkbox (optional validation later) -->
                                <div x-data="{ checkboxToggle: false }">
                                    <label
                                        class="flex items-start text-sm font-normal text-gray-700 dark:text-gray-400">
                                ...
                                <div>
                                    <button type="submit"
                                        class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-brand-500 hover:bg-brand-600">
                                        Sign Up
                                    </button>
                                </div>
