                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            ...
                                            <input :type="showPassword ? 'text' : 'password'" name="password"
                                                ...
                                                class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm"
                                                required />
                ...
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        ...
                        <a href="index.php" class="block mb-6">
                            <img class=" animate-logo" src="../assets/images/logo/logo1.png" alt="Logo">
                        </a>
